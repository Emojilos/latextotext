...
_current_dir = str(pathlib.Path(__file__).resolve().parent)
if "" in sys.path:
    sys.path.remove("")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Convert LaTeX to readable text on a dark themed page."
    )
    parser.add_argument(
        "-f",
        "--file",
